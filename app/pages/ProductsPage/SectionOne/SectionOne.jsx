            ...
            <div className=' h-auto' style={{backgroundImage: `url(/Img/Header.jpg) `, backgroundSize: 'cover'}}>
                ...
                <div className='flex items-center justify-start lg:p-28 md:p-14 p-10'>
                    ...
                    <div className='border-l-[5px] border-[#D62923] rounded-md mt-20'>
                        ...
                        <div
                            className=" font-Inter  md:text-7xl text-[30px]   leading-snug text-[#fff]  md:ms-10 ms-5 my-4">
                            As a Products ?
                        </div>
                    </div>
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    ...
                                    <span
                                        className="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Products</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
