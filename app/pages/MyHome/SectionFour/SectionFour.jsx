...
import img3 from '../../../../public/Img/cardimg3.png';
import img5 from '../../../../public/Img/12.png';
...
import { Pagination ,FreeMode,EffectCoverflow,
    Navigation , Autoplay } from 'swiper/modules';

import {BsArrowLeftCircleFill, BsArrowLeftSquareFill, BsArrowRightSquareFill} from "react-icons/bs";
            ...
            <div className='p-20'>
                ...
                <div>
                    ...
                    <div className='flex items-center justify-center gap-3 my-10 '>
                        <BsArrowLeftSquareFill className='next-arrow text-3xl text-[#D62923] hover:opacity-80 '/>
                        <BsArrowRightSquareFill className='prev-arrow text-3xl text-[#D62923] hover:opacity-80'/>
